...
ldd.reload_all(update_which_templates=["flat512"], oskar_parent_dir=SETONIX_DATA_DIR_SCRATCH)

# Then do everything else
ldd.reload_all(update_which_templates=ldd.TEMPLATES - {"flat512"}, oskar_parent_dir=SETONIX_DATA_DIR_SCRATCH)
